...
export async function generateMetadata({
  ...
  return {
    title: locale === "en"
      ? "Personalized Planning — Allura Aligners™"
      : "Planificación Personalizada — Allura Aligners™",
    description: locale === "en"
      ? "Animated simulation of your orthodontic treatment in Medellín. See step by step how your teeth will move before starting."
      : "Simulación animada de tu tratamiento de ortodoncia en Medellín. Ve paso a paso cómo se moverán tus dientes antes de comenzar.",
  };
}
