...
export async function generateMetadata({
  ...
  return {
    title: locale === "en"
      ? "Rhinoplasty — Allura Facial Harmony™"
      : "Rinoplastia — Allura Facial Harmony™",
    description: locale === "en"
      ? "Nasal refinement surgery in Medellín in harmony with your facial features. Aesthetic and functional rhinoplasty under strict medical criteria."
      : "Refinamiento de la nariz en Medellín en equilibrio con tus rasgos faciales. Rinoplastia estética y funcional bajo criterio médico estricto.",
  };
}
