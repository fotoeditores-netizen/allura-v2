...
export async function generateMetadata({
  ...
  return {
    title: locale === "en"
      ? "Blepharoplasty — Allura Facial Harmony™"
      : "Blefaroplastia — Allura Facial Harmony™",
    description: locale === "en"
      ? "Eyelid surgery in Medellín for a more rested and youthful look. Upper and lower blepharoplasty."
      : "Cirugía de párpados en Medellín para una mirada más descansada y juvenil. Blefaroplastia superior e inferior.",
  };
}
