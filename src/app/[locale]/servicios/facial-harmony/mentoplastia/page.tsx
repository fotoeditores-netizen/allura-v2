...
export async function generateMetadata({
  ...
  return {
    title: locale === "en"
      ? "Mentoplasty — Allura Facial Harmony™"
      : "Mentoplastia — Allura Facial Harmony™",
    description: locale === "en"
      ? "Chin redefinition in Medellín to improve your profile and facial balance. Minimally invasive with fast recovery."
      : "Redefinición del mentón en Medellín para mejorar el perfil y el equilibrio facial. Mínimamente invasivo con recuperación rápida.",
  };
}
