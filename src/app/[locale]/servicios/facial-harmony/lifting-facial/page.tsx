...
export async function generateMetadata({
  ...
  return {
    title: locale === "en"
      ? "Facelift — Allura Facial Harmony™"
      : "Lifting Facial — Allura Facial Harmony™",
    description: locale === "en"
      ? "Facelift surgery in Medellín to reposition tissues and restore facial definition without artificial results."
      : "Cirugía de lifting facial en Medellín para reposicionar tejidos y restaurar la definición facial sin resultados artificiales.",
  };
}
