...
export async function generateMetadata({
  ...
  return {
    title: locale === "en"
      ? "Maxillofacial Surgery Coordination — Allura Facial Harmony™"
      : "Coordinación con Cirugía Maxilofacial — Allura Facial Harmony™",
    description: locale === "en"
      ? "Interdisciplinary planning in Medellín between dentistry and maxillofacial surgery for cases requiring facial bone correction."
      : "Planificación interdisciplinaria en Medellín entre odontología y cirugía maxilofacial para casos que requieren corrección ósea facial.",
  };
}
